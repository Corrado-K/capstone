            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container grid px-12 mx-auto">
                    ...
                    <!-- <div class="h-full px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                     ...
                     -->
                    <!-- Card code from home for the mini-dashboard -->
                    <div class="grid gap-2 mb-8 grid-cols-3">
                        <!-- Card -->
                        <?php if (isset($lecturers)) {
                                foreach ($lecturers as $lecturer) {
                                    echo '
                                        <div class="flex items-center py-4 pl-4 bg-white rounded-lg shadow-xs">
                                            <div class="p-3 mr-4 text-orange-500 bg-orange-100 rounded-full">
                                                <i class="fas fa-user w-5 h-5 text-center text-xl"></i>
                                            </div>
                                            <div>
                                                <p class="mb-2 text-lg font-semithin text-gray-600">
                                                '.$lecturer['lecturer_name'].' 
                                                </p>
                                                <p class="text-md font-thin text-gray-700">
