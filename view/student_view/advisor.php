...
<div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
  ...
  <div class="container overflow-y-auto my-4 mx-auto md:-ml-9 md:mr-5 rounded-[30px] p-5 bg-white h-[95 vh]">
    <h4 class="p-10 text-2xl font-bold">Academic advisor</h4>
    <div class="inline-flex flex-row self-center justify-center px-10 overflow-x-auto bg-white">
    ...
    <h4 class="p-10 text-2xl font-bold">Advisors</h4>
    <div class="flex flex-row px-10 bg-white overflow-x">

      <!-- <div class="container w-48 mr-10 overflow-hidden duration-500 transform bg-white shadow-lg rounded-xl hover:shadow-2xl hover:scale-105">
        <img class="w-full" src="https://i.imgur.com/iObhoAx.png" alt="" />
        <div class="relative py-1 text-center">
          <h1 class="mb-1 font-sans text-xl font-semibold text-gray-700 cursor-pointer hover:text-gray-900">Name</h1>
          <span class="text-lg text-gray-700 hover:text-gray-900">Unit</span><br>
          <span class="text-sm text-gray-700 hover:text-gray-900">Short quote</span>
        </div>
      </div>

      <div class="container w-48 overflow-hidden duration-500 transform bg-white shadow-lg rounded-xl hover:shadow-2xl hover:scale-105">
        <img class="w-full" src="https://i.imgur.com/iObhoAx.png" alt="" />
        <div class="relative py-1 text-center">
          <h1 class="mb-1 font-sans text-xl font-semibold text-gray-700 cursor-pointer hover:text-gray-900">Name</h1>
          <span class="text-lg text-gray-700 hover:text-gray-900">Unit</span><br>
