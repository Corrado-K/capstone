...
<div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
  ...
  <div class="container overflow-y-auto my-4 mx-auto md:-ml-9 md:mr-5 rounded-[30px] p-5 bg-white h-[95 vh]">
    ...
    <h4 class="pl-10 pt-5 pb-10 font-bold text-2xl">Whichever advising unit was selected</h4>
    <div class="bg-white overflow-x-auto inline-flex flex-row px-10"></div> 
    <h4 class="p-10 font-bold text-2xl">Advisors</h4>
    <div class="w-100 pr-5 mb-10 flex flex-row flex-wrap overflow-x-auto"></div>
  </div>
</div>
