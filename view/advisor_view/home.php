...
<div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
  ...
  <div class="container overflow-y-auto my-4 mx-auto md:-ml-9 md:mr-5 rounded-[30px] py-5 px-10 bg-white h-[95vh]">
    ...
    <div class="bg-gray-300 mt-10 mx-5 text-black rounded-md text-center overflow-x block px-10">
      <h4 class="px-10 pt-6 pb-4 mx-auto font-semibold text-3xl">Welcome "Faculty name" to the Student Advising System</h4>
      <p class="text-lg font-normal text-justify pb-5">
    ...
    <div class="bg-gray-300 mt-10 mx-5 text-black rounded-md text-center overflow-x flex flex-row px-10">
