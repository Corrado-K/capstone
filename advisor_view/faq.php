...
<head>
  ...
  <title>Student Advising System - FAQ</title>
  ...
  <div class="flex h-screen bg-zinc-200" :class="{ 'overflow-hidden': isSideMenuOpen}">
    ...
    <div class="flex flex-col flex-1">
      <header class="z-10 py-4 bg-white shadow-md">
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-[#923]">
          <!-- Mobile hamburger -->
        ...
        <div class="container grid px-12 mx-auto">
          ...
          <div class="h-full px-4 py-3 mb-3 mb-8 bg-white rounded-lg shadow-md">
            ...
            <form action="../action/faq_action.php" method="post">
              ...
              <button name="add_faq" class="px-4 mt-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-[#923] border border-transparent rounded-lg active:bg-[#923] hover:bg-[#923] focus:outline-none focus:shadow-outline-[#923] rounded-full">
                  Submit
              </button>
            </form>
          </div>
          ...
          <div class="h-full px-4 py-3 mb-3 mb-8 bg-white rounded-lg shadow-md">
            ...
            <form action="../action/faq_action.php" method="post" enctype="multipart/form-data">
              ...
              <button name="process_faq_csv" class="px-4 mt-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-[#923] border border-transparent rounded-lg active:bg-[#923] hover:bg-[#923] focus:outline-none focus:shadow-outline-[#923] rounded-full">
                  Submit
              </button>
            </form>
          </div>
