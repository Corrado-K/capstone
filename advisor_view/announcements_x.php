...
<body>
  ...
  <!-- <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
    ...
    <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
      ...
      <div class="mt-4 mb-6">
        <span class="mb-2 text-lg font-semibold text-gray-700">
          Do you want to delete </span><span class="mb-2 text-xl font-semibold text-gray-800" id="ann_subject"><span class="mb-2 text-md font-base" id="ann_subject"></span>?</span>
