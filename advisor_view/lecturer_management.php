...
$number_of_page = ceil (count($lecturers) / $results_per_page);  
...
<head>  
    ...
    <title>Student Advising System - Lecturer Management</title>
                    ...
                    <div class="flex items-center p-4 mb-4 bg-white border-solid border-1 border-black rounded-lg shadow-xs">
                        ...
                        <div class="mx-auto text-center">
                            ...
                            <p class="font-semibold text-center text-gray-700 text-md">
                                Lecturer related affair of the system can be managed here. 
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t bg-gray-50 sm:grid-cols-9">
                            <span class="flex items-center col-span-3">
                                Showing <?php echo ($page*10)-(10-1)?> - <?php if($page*10 < count($lecturers)){echo $page*10;}else{echo count($lecturers);} ?> of <?php echo count($lecturers);?>
                            </span>
