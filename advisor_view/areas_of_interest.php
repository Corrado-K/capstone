    ...
    <form action="../action/aoi_action.php" method="post" enctype="multipart/form-data">
      ...
      <label class="block mt-4 text-sm">
        ...
        <textarea
          ...
          rows="8" name="aoi_desc" id="aoi_desc" placeholder="Enter description" ></textarea>
      </label>
      <button name="edit_aoi" class="px-4 mt-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-[#923] border border-transparent rounded-lg active:bg-[#923] hover:bg-[#923] focus:outline-none focus:shadow-outline-[#923] rounded-full">
          Submit
      </button>
    </form>
  </div>
