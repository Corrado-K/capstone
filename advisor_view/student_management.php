...
<head>  
    ...
    <title>Student Advising System - Student Management</title>
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container grid px-12 mx-auto">
                    ...
                    <div class="flex items-center p-4 mb-4 bg-white border-solid border-1 border-black rounded-lg shadow-xs">
                        ...
                        <div class="mx-auto text-center">
                            ...
                            <p class="font-semibold text-center text-gray-700 text-md">
                                Student related affair of the system can be managed here. Track meetings and enter meeting minutes here to keep record of what goes on.
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- <div class="w-full flex">
                        <div class="h-full w-1/2 px-4 py-3 mr-10 mb-8 bg-white rounded-lg shadow-md">
                            <h2 class="text-2xl font-semibold">Number of meetings</h2>
                        </div>
                        <div class="h-full w-1/2 px-4 py-3 mb-8 bg-white rounded-lg shadow-md"></div>
                    </div> -->
                        ...
                        <!-- <form action="../action/lecturer_action.php" method="post" enctype="multipart/form-data">
                            ...
                            <input
                                ...
                                name="name" placeholder="Lecturer name" />
                            </label>
                            ...
                            <input
                                class="block w-full mt-1 text-sm rounded-full focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                type="email" name="email" placeholder="Lecturer email" />
                            </label>
                            ...
                            <input
                                class="block w-full mt-1 text-sm rounded-full focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                type="tel" name="contact" placeholder="Lecturer contact" />
                            </label>

                            <button type="submit" name="add_lecturer" class="px-4 mt-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-[#923] border border-transparent rounded-lg active:bg-[#923] hover:bg-[#923] focus:outline-none focus:shadow-outline-[#923] rounded-full">
                                Submit
                            </button>
                        </form> -->
                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <?php if (isset($students)) {
                                foreach ($students as $student) {
                                    ...
                                    <td class="px-4 py-3"><p class="font-normal">' .$student['student_name'] .'</p></td>
                                    <td class="px-4 py-3"><p class="font-normal">' .$student['student_email'] .'</p></td>
                                    <td class="px-4 py-3"><p class="font-normal">' .$student['student_contact'] .'</p></td>                    
                                    <td class="px-4 py-3">
...
$(document).ready(function(){
    $('.deletebtn').on('click',function(){
      ...
      $('#student_name').text(data[1]);

      var subject =  data[1];
      var id =  data[0]

      Swal.fire({
        title: `Are you sure you want to delete "${subject}" from the system?`,
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            type:"POST",
            url: '../action/student_management_action.php',
            data: {
              delete_student:true,
              student_id: id
            },
...
<div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
  ...
  <div class="mt-4 mb-6">
    ...
    <!-- Modal description -->
    <form action="../action/student_management_action.php" method="post" enctype="multipart/form-data">
      ...
      <button name="edit_student" class="px-4 mt-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-[#923] border border-transparent rounded-lg active:bg-[#923] hover:bg-[#923] focus:outline-none focus:shadow-outline-[#923] rounded-full">
          Submit
      </button>
    </form>
  </div>
