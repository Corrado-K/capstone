...
class Zoom_Api
{
	private $zoom_api_key = 'M_dG-V8MQCCdz5620Xobbw';
	private $zoom_api_secret = '9bePqd8MDCg0H6kL2GjyyH1kyhtkkOt8Pok0';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/kebemartey@gmail.com/meetings"; // change the email to a user's email variable
