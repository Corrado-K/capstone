...
require '../class/lecturer_class.php';
...
function update_lecturer_controller($lecturer_id, $name,$email,$contact){
    // create an instance of the lecturer class
    $lecturer_instance = new Lecturer();
    // call the method from the class
    return $lecturer_instance->update_lecturer($lecturer_id,$name,$email,$contact);
